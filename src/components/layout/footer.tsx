...
export default function Footer() {
  return (
    <div className="absolute w-full text-center">
      <section className="py-6 bg-[#36324A] text-gray-900">
        <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium tracking-widest uppercase text-gray-400">Elevate Your Influence.
            </p>
            <h1 className="py-2 text-3xl font-medium leading-tight title-font text-white">Vibe</h1>
          </div>
          <div
